...
// Inisialisasi indikator awal
updateIndicators();

document.querySelector('.slider-container .arrow.left')
        .addEventListener('click', function() {
          prevSlide();
        })

document.querySelector('.slider-container .arrow.right')
        .addEventListener('click', function() {
          nextSlide();
        })